      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 pt-6">
          <div className="flex space-x-8">
            <Github className="w-5 h-5 text-main hover:text-tate-blue hover:scale-110 cursor-pointer transition-all" />
            <Linkedin className="w-5 h-5 text-main hover:text-tate-blue hover:scale-110 cursor-pointer transition-all" />
            <Instagram className="w-5 h-5 text-main hover:text-tate-blue hover:scale-110 cursor-pointer transition-all" />
            <Mail className="w-5 h-5 text-main hover:text-tate-bluehover:scale-110 cursor-pointer transition-all" />
          </div>
